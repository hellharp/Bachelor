...
namespace Databar
{
    public static class Constants
    {
        ...
        public static string RestUrl = "https://178.62.20.236:8443/restsql/res/databar_db.{0}/{1}{2}";
        ...
        // Credentials for default tomcat user "all", which has only select/readonly-access to the restSQL API.
        public static string Username = "all";
        public static string Password = "all";

        // Admin
        public static string Admin = "admin";
        public static string AdminAuthUrl = "https://178.62.20.236:8443/restsql/conf/security";
    }
}
